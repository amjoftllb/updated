...
import InputTick from "@/components/inputTick";
...
function Registration() {
  ...
  const RegisterUser = async () => {
    ...
    try {
      ...
      setApiRes((prev) => ({
        ...prev,
        RegisterUserRes: result.message,
      }));
      ...
      <div className="max-w-5xl m-auto  bg-white bg-opacity-50 rounded-lg shadow-lg p-6 m-6 ">
        ...
        >
          ...
          <div className="md:col-span-2">
            {apiRes.RegisterUserRes && (
              <p className="text-green-700 text-lg" onClick={goToLogin}>
                {apiRes.RegisterUserRes} <br /> click Here To LogIn
              </p>
            )}
